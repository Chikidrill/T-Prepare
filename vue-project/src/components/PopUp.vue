<template>
  <div v-if="isVisible" class="popup" :class="{ closing: isClosing }" @click="closePopup">
    <div class="popup__content" :class="{ closing: isClosing }" @click.stop>
      <p class="popup__title"><b>Выбранный предмет:</b> {{ subjectName }}</p>
      <button class="close-btn btn" @click="closePopup">
      ...
      <div class="popup__buttons">
        <button class="share-btn btn" @click="isSharePopupVisible = true">
          Поделиться
        ...
        <button class="test-btn btn" @click="goToExam">
          Создать тест
        </button>
      </div>
    </div>
